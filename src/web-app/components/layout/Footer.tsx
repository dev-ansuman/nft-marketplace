                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <div className="relative flex flex-col sm:flex-row items-center w-full">
                            <input
                                ...
                                className="w-full bg-white rounded-2xl px-5 sm:pr-[160px] h-[60px] text-black outline-none placeholder:text-[#2B2B2B]/60"
                            />
                            <Button className="w-full mt-4 sm:mt-0 sm:absolute right-0 sm:w-auto bg-[#A259FF] rounded-2xl px-12 h-[60px] text-white font-semibold transition-all hover:scale-[0.97] cursor-pointer">
                                Subscribe
                            </Button>
                        </div>
                    </div>
